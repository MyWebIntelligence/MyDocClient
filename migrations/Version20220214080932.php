 ...
 */
final class Version20220214080932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_link ADD content LONGTEXT NOT NULL');
    }
